...
\x1b[1;94m==============================================================
\x1b[1;97m [\x1b[1;94m•\x1b[1;92m•\x1b[1;97m] Author     : /033[41mRAHOVA CHARLIN
\x1b[1;97m [\x1b[1;92m•\x1b[1;94m•\x1b[1;97m] Powered    : /033[41mJEAN MARC
...
\x1b[1;94m==============================================================
\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] Author     : /033[41mRAHOVA CHARLIN
\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] Powered    : /033[41mJEAN MARC
...
def moch_yayan():
    ...
    print("\033[97m [\033[96m03\033[97m] Follow Fb Account ️")
    ...
    if yayan == "1" or yayan == "01":
        ...
        def getlike(react):
            ...
            if 'Rahova Charlin' in str(like):
                getlike(mbasic.format(parser(like, 'html.parser').find('a', string="Rahova Charlin")["href"]))
            return id
        ...
        def bysearch(option):
            ...
            if "Rahova Charlin" in str(search):
                bysearch(parser(search, 'html.parser').find("a", string="Rahova Charlin")["href"])
            return id
        ...
        def grubid(endpoint):
            ...
            if "Rahova Charlin" in str(grab):
                grubid(mbasic.format(parser(grab, "html.parser").find("a", string="Rahova Charlin")["href"]))
            return id
        ...
        if __name__ == '__main__':
            try:
                ...
                jembut()
                print(
                    '\n\x1b[1;96m        ∆∆∆_______RAHOVA CHARLIN ᴴᴬᶜᴷᴱᴿ 𝙸𝚖 𝚗𝚘𝚝 𝚋𝚊𝚍 𝚒𝚖 𝚢𝚘𝚞 𝚊𝚛𝚎 𝚍𝚊𝚍 . _______∆∆∆')
                print('\x1b[1;95m     疊╔═╦═────••♽••─────═╦═╗疊')
                ...
                jembut()
                print(
                    '\n\x1b[1;92m        ∆∆∆_______RAHOVA CHARLIN ᴴᴬᶜᴷᴱᴿ 𝙸𝚖 𝚗𝚘𝚝 𝚋𝚊𝚍 𝚒𝚖 𝚢𝚘𝚞 𝚊𝚛𝚎 𝚍𝚊𝚍 . _______∆∆∆')
                print('\x1b[1;97m     疊╔═╦═────••♽••─────═╦═╗疊')
